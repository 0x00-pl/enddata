...
用法:
    python3 scripts/fetch_tablecfg.py              # 抓取 config/sources.json 中的 core_tables
    python3 scripts/fetch_tablecfg.py ItemTable EnemyTable   # 只抓指定表
    python3 scripts/fetch_tablecfg.py --force      # 忽略本地缓存强制重新抓取
"""
